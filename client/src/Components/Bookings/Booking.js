...
export default function Booking(props) {
  ...
  if (props.booking) {
    if (Moment(new Date(request.start)).isSame(new Date(request.end), "day")) {
      ...
      duration = Moment(new Date(request.start))
        .format("D MMMM YYYY, hA")
        .concat(" - ")
        .concat(Moment(new Date(request.end)).format("hA"));
    } else {
      duration = Moment(new Date(request.start))
        .format("D MMMM YYYY, hA")
        .concat(" - ")
        .concat(Moment(new Date(request.end)).format("D MMMM YYYY, hA"));
    }
    ownerFullName = ownerProfile.firstName
      .concat(" ")
      .concat(ownerProfile.lastName);
